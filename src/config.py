...
THEME_MAPPING_DICT = {
    'Классика': ['квиз, плиз! nsk', 'железные яйца', 'блиц', 'классика', 'обо всём', '#обовсём', 'fun','эйнштейн party',
                 'новички', 'большая игра'],
    'Мультимедиа': ['музыка','кино','шазам','сериал','мультфильм','мультик','гарри поттер','мелоди','друзья','аниме',
                    ...
                    'компьютерн','видео','марвел','мстител','marvel', 'спорт', 'караоке', 'хиты'],
    'Новички': ['новички', 'проще некуда'],
...
CITY_DICT = {
    ...
    'Новосибирск': {
        'bars': ['Три лося', 'Арт П.А.Б.', 'Максимилианс', 'Типография', 'Руки Вверх',
                 "Harat's pub", 'Друзья', 'Волковская пивоварня', 'Раковарня', 'Паб Клевер'],
        'ein': 'nsk',
        'li': 'novosibirsk',
        'qp': 'nsk',
        'shaker': 'novosibirsk',
